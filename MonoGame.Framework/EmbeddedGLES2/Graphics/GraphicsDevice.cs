		...
		public void SetRenderTarget (RenderTarget2D renderTarget)
		{
			...
			if (renderTarget == null || currentRenderTargets != null)
			{
				...
				GL.BindFramebuffer(FramebufferTarget.Framebuffer, renderTarget.frameBuffer);
                		GL.FramebufferTexture2D(FramebufferTarget.Framebuffer, FramebufferSlot.ColorAttachment0, TextureTarget.Texture2D, renderTarget.ID, 0);
...
//        }
	...
	internal BeginMode PrimitiveTypeGL20(PrimitiveType primitiveType)
        {
            switch (primitiveType)
            {
                case PrimitiveType.LineList:
        ...
        public void SetVertexBuffer(VertexBuffer vertexBuffer)
        {
            ...
            GL.BindBuffer(BufferTarget.ArrayBuffer, (int) vertexBuffer._bufferStore);
        }

        private void SetIndexBuffer(IndexBuffer indexBuffer)
        {
            _indexBuffer = indexBuffer;
            GL.BindBuffer(BufferTarget.ElementArrayBuffer, (int) indexBuffer._bufferStore);
        }
        ...
        public void DrawIndexedPrimitives(PrimitiveType primitiveType, int baseVertex, int minVertexIndex, int numbVertices, int startIndex, int primitiveCount)
        {
            ...
            GL.DrawElements(PrimitiveTypeGL20(primitiveType), _indexBuffer._count, DrawElementsType.UnsignedShort, new IntPtr(startIndex));
        }
        ...
        public void DrawUserPrimitives<T>(PrimitiveType primitiveType, T[] vertexData, int vertexOffset, int primitiveCount) where T : struct, IVertexType
        {
            ...
            GL.DrawArrays(PrimitiveTypeGL20(primitiveType), vertexOffset, getElementCountArray(primitiveType, primitiveCount));
        }
        ...
        public void DrawPrimitives(PrimitiveType primitiveType, int vertexStart, int primitiveCount)
        {
            ...
            GL.DrawArrays(PrimitiveTypeGL20(primitiveType), vertexStart, getElementCountArray(primitiveType, primitiveCount));
        }
