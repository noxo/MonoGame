...
namespace Microsoft.Xna.Framework
{
	public class GraphicsDeviceManager : IGraphicsDeviceService, IDisposable, IGraphicsDeviceManager
	{
		...
		{			
			_game.resizeGameWindow(_preferredBackBufferWidth, _preferredBackBufferHeight);
			_graphicsDevice.SizeChanged(_preferredBackBufferWidth, _preferredBackBufferHeight);
		}
