...
namespace Microsoft.Xna.Framework
{
	...
	{	
		...
		{
			Console.WriteLine ("OnResize: " +window.ClientRectangle.Width + "/" + window.ClientRectangle.Height);
		...
		{	
			...
			updateClientBounds = false;
			Console.WriteLine("bounds on create: " + window.ClientRectangle.Width + "/" + window.ClientRectangle.Height);
